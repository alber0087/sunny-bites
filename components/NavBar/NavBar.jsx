...
export default function NavbarWithDropdown() {
  ...
  return (
    <Navbar
      fluid
      rounded
      className="bg-red-500 text-white justify-center w-screen"
    >
      <Navbar.Brand href="/">
      ...
      <Autocomplete onLoad={onLoad} onPlaceChanged={onPlaceChanged}>
        <div className="relative">
          ...
          <input
            type="text"
            id="search-navbar"
            className="block w-full p-2 pl-10 text-sm text-gray-900 rounded-lg bg-gray-50 focus:ring-red-500 focus:border-red-500"
            placeholder="Search..."
          />
        </div>
      </Autocomplete>
